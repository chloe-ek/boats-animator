const enum IpcChannel {
  ...
  OPEN_EXPORT_VIDEO_FILE_PATH_DIALOG = "OPEN_EXPORT_VIDEO_FILE_PATH_DIALOG",
  EXPORT_VIDEO_START = "EXPORT_VIDEO_START",
  ON_EXPORT_VIDEO_DATA = "ON_EXPORT_VIDEO_DATA",
  SHOW_ITEM_IN_FOLDER = "SHOW_ITEM_IN_FOLDER",
  COPY_FRAMES_TO_TEMP_DIRECTORY = "COPY_FRAMES_TO_TEMP_DIRECTORY",
  EXPORT_TAKE = "EXPORT_TAKE",
  CONFORM_TAKE = "CONFORM_TAKE",
  EXPORT_TAKE_FINISHED = "EXPORT_TAKE_FINISHED",
}
